...
(Get-Content .env) -replace 'VITE_BACKEND_API_URL=.*', 'VITE_BACKEND_API_URL=https://backup.traderbias.app' | Set-Content .env
...
Write-Host "`n[OK] Deployed to https://backup.traderbias.app/" -ForegroundColor Green
